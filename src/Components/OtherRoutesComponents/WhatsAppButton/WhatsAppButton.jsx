...
const WhatsAppButton = () => {
    // WhatsApp API URL - you can customize this
    const whatsappNumber = "+918866415586"; // Agilux Solution WhatsApp number
    const defaultMessage = `Hello! 👋 

I'm interested in *Agilux Solution's* services for:
...
Thank you!`;
    ...
    return (
        <div className="WhatsAppButtonContainer" onClick={handleWhatsAppClick}>
            <div className="WhatsAppButtonPulse"></div>
